...
public class TicketController {
    ...
    public BaseResponse<String> change(
        ...
        @RequestBody @Valid ActionTicketRequest request
    ) throws Exception {
        changeTicketStatusUseCase.change(ticketId, request.action(), request.comment());
    ...
    public BaseResponse<String> update(
        ...
        updateTicketUseCase.update(ticketId, ticketMapper.toTicket(request));
