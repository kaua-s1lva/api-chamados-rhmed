...
@Service
public class RequestInformationTicketGatewayImpl implements ChangeTicketStatusHandlerGateway {
    private final TicketEntityRepository ticketEntityRepository;
    private final TicketMapper ticketMapper;

    public RequestInformationTicketGatewayImpl(TicketEntityRepository ticketEntityRepository, TicketMapper ticketMapper) {
